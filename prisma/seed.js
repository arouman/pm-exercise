...
const users = [
  { id: 'usr_proc_1', name: 'Diana Chen', email: 'diana.chen@subbase.demo', role: 'PROCUREMENT' },
  {
    id: 'usr_proc_2',
    name: 'Marcus Patel',
    email: 'marcus.patel@subbase.demo',
    role: 'PROCUREMENT',
  },
  {
    id: 'usr_proc_3',
    name: 'Sasha Ivanova',
    email: 'sasha.ivanova@subbase.demo',
    role: 'PROCUREMENT',
  },
  {
    id: 'usr_super_1',
    name: 'Eli Brooks',
    email: 'eli.brooks@subbase.demo',
    role: 'SUPERINTENDENT',
  },
  {
    id: 'usr_super_2',
    name: 'Tomas Reyes',
    email: 'tomas.reyes@subbase.demo',
    role: 'SUPERINTENDENT',
  },
  {
    id: 'usr_super_3',
    name: 'Priya Shah',
    email: 'priya.shah@subbase.demo',
    role: 'SUPERINTENDENT',
  },
  {
    id: 'usr_super_4',
    name: 'Jordan Nakai',
    email: 'jordan.nakai@subbase.demo',
    role: 'SUPERINTENDENT',
  },
  {
    id: 'usr_fleet_1',
    name: 'Robin Castillo',
    email: 'robin.castillo@subbase.demo',
    role: 'FLEET_MANAGER',
  },
];
...
const vendors = [
  {
    id: 'vnd_concrete',
    name: 'Cornerstone Concrete Supply',
    category: 'CONCRETE',
    contactEmail: 'sales@cornerstonecs.com',
    contactPhone: '+1 415-555-2010',
    paymentTerms: 'Net 30',
  },
  {
    id: 'vnd_rebar',
    name: 'Ironline Reinforcement Co.',
    category: 'REBAR',
    contactEmail: 'orders@ironline.com',
    contactPhone: '+1 213-555-7788',
    paymentTerms: 'Net 30',
  },
  {
    id: 'vnd_fasteners',
    name: 'Bolthouse Industrial',
    category: 'FASTENERS',
    contactEmail: 'service@bolthouse.com',
    contactPhone: '+1 312-555-3401',
    paymentTerms: 'Net 15',
  },
  {
    id: 'vnd_lumber',
    name: 'Pacific Lumber & Form',
    category: 'LUMBER',
    contactEmail: 'desk@paclumber.com',
    contactPhone: '+1 503-555-9120',
    paymentTerms: 'Net 30',
  },
  {
    id: 'vnd_rental',
    name: 'Western Equipment Rentals',
    category: 'TOOLS_RENTAL_EXTERNAL',
    contactEmail: 'rentals@westernequip.com',
    contactPhone: '+1 602-555-4477',
    paymentTerms: 'Net 15',
  },
];
...
const materials = [
  // Concrete (vnd_concrete)
  {
    id: 'mat_c_4000',
    sku: 'CON-4000',
    name: '4000 PSI Ready-Mix Concrete',
    category: 'CONCRETE',
    unit: 'CY',
    unitPrice: 165.0,
  ...
  },
  {
    id: 'mat_c_5000',
    sku: 'CON-5000',
    name: '5000 PSI Ready-Mix Concrete',
    category: 'CONCRETE',
    unit: 'CY',
    unitPrice: 185.0,
    vendorId: 'vnd_concrete',
  ...
  },
  {
    id: 'mat_c_cure',
    sku: 'CON-CURE',
    name: 'Concrete Curing Compound, 5 gal',
    category: 'CONCRETE',
    unit: 'EA',
    unitPrice: 78.0,
    vendorId: 'vnd_concrete',
  },
  {
    id: 'mat_c_seal',
    sku: 'CON-SEAL',
    name: 'Penetrating Concrete Sealer, 5 gal',
    category: 'CONCRETE',
    unit: 'EA',
    unitPrice: 142.0,
    vendorId: 'vnd_concrete',
  ...
  },
  {
    id: 'mat_c_fiber',
    sku: 'CON-FBR',
    name: 'Synthetic Fiber Mesh, 1.5 lb bag',
    category: 'CONCRETE',
    unit: 'BAG',
    unitPrice: 12.25,
    vendorId: 'vnd_concrete',
  ...
  },
  {
    id: 'mat_r_tie',
    sku: 'RBR-TIE',
    name: 'Black Annealed Tie Wire 16 ga, 3.5 lb roll',
    category: 'REBAR',
    unit: 'EA',
    unitPrice: 8.75,
    vendorId: 'vnd_rebar',
  ...
  },
  {
    id: 'mat_r_mesh',
    sku: 'RBR-MESH',
    name: 'Welded Wire Mesh 6x6, 5 ft x 10 ft',
    category: 'REBAR',
    unit: 'EA',
    unitPrice: 38.5,
    vendorId: 'vnd_rebar',
  ...
  // Fasteners (vnd_fasteners)
  {
    id: 'mat_f_anchor_1',
    sku: 'FST-ANC-1/2',
    name: 'Wedge Anchor 1/2 x 4 3/4 in',
    category: 'FASTENERS',
    unit: 'EA',
    unitPrice: 1.85,
    vendorId: 'vnd_fasteners',
  },
  {
    id: 'mat_f_anchor_2',
    sku: 'FST-ANC-3/4',
    name: 'Wedge Anchor 3/4 x 7 in',
    category: 'FASTENERS',
    unit: 'EA',
    unitPrice: 3.65,
    vendorId: 'vnd_fasteners',
  },
  {
    id: 'mat_f_bolt_a',
    sku: 'FST-BLT-A325',
    name: 'A325 Structural Bolt 3/4 x 2 1/2 in',
    category: 'FASTENERS',
    unit: 'EA',
    unitPrice: 2.1,
    vendorId: 'vnd_fasteners',
  },
  {
    id: 'mat_f_bolt_b',
    sku: 'FST-BLT-A490',
    name: 'A490 High-Strength Bolt 7/8 x 3 in',
    category: 'FASTENERS',
    unit: 'EA',
    unitPrice: 4.8,
    vendorId: 'vnd_fasteners',
  },
  {
    id: 'mat_f_nut',
    sku: 'FST-NUT-A325',
    name: 'A325 Heavy Hex Nut 3/4 in',
    category: 'FASTENERS',
    unit: 'EA',
    unitPrice: 0.55,
    vendorId: 'vnd_fasteners',
  },
  {
    id: 'mat_f_washer',
    sku: 'FST-WSH',
    name: 'F436 Hardened Washer 3/4 in',
    category: 'FASTENERS',
    unit: 'EA',
    unitPrice: 0.22,
    vendorId: 'vnd_fasteners',
  },
  {
    id: 'mat_f_screw',
    sku: 'FST-TEK-3',
    name: 'Tek Self-Drilling Screw #12 x 3 in',
    category: 'FASTENERS',
    unit: 'EA',
    unitPrice: 0.18,
    vendorId: 'vnd_fasteners',
  },
  {
    id: 'mat_f_epoxy',
    sku: 'FST-EPX',
    name: 'Anchoring Epoxy Adhesive, 22 oz',
    category: 'FASTENERS',
    unit: 'EA',
    unitPrice: 38.0,
    vendorId: 'vnd_fasteners',
  ...
  },
  {
    id: 'mat_l_ply_3/4',
    sku: 'LMB-PLY-3/4',
    name: '3/4 in CDX Plywood, 4x8 sheet',
    category: 'LUMBER',
    unit: 'EA',
    unitPrice: 58.0,
    vendorId: 'vnd_lumber',
  ...
  },
  {
    id: 'mat_l_lvl',
    sku: 'LMB-LVL-16',
    name: '1 3/4 x 11 7/8 LVL Beam, 16 ft',
    category: 'LUMBER',
    unit: 'EA',
    unitPrice: 184.0,
    vendorId: 'vnd_lumber',
  },
  {
    id: 'mat_l_screws',
    sku: 'LMB-DECK-3',
    name: 'Deck Screws 3 in, 5 lb box',
    category: 'LUMBER',
    unit: 'EA',
    unitPrice: 32.5,
    vendorId: 'vnd_lumber',
  },
  {
    id: 'mat_l_nails',
    sku: 'LMB-NAIL-16',
    name: '16d Framing Nails, 50 lb box',
    category: 'LUMBER',
    unit: 'EA',
    unitPrice: 78.0,
    vendorId: 'vnd_lumber',
  ...
  // currently treats external rentals as a vendor purchase).
  {
    id: 'mat_t_compactor',
    sku: 'TLS-COMP-PLT',
    name: 'Plate Compactor Daily Rental',
    category: 'TOOLS_RENTAL_EXTERNAL',
    unit: 'EA',
    unitPrice: 95.0,
    vendorId: 'vnd_rental',
  ...
  {
    id: 'mat_t_concrete_saw',
    sku: 'TLS-SAW-CNC',
    name: 'Walk-Behind Concrete Saw Daily Rental',
    category: 'TOOLS_RENTAL_EXTERNAL',
    unit: 'EA',
    unitPrice: 215.0,
    vendorId: 'vnd_rental',
  },
  {
    id: 'mat_t_pump',
    sku: 'TLS-PUMP-3',
    name: '3 in Submersible Pump Daily Rental',
    category: 'TOOLS_RENTAL_EXTERNAL',
    unit: 'EA',
    unitPrice: 75.0,
    vendorId: 'vnd_rental',
  },
  {
    id: 'mat_t_genset',
    sku: 'TLS-GEN-25',
    name: '25 kW Towable Generator Daily Rental',
    category: 'TOOLS_RENTAL_EXTERNAL',
    unit: 'EA',
    unitPrice: 245.0,
    vendorId: 'vnd_rental',
  },
  {
    id: 'mat_t_lift',
    sku: 'TLS-LIFT-26',
    name: '26 ft Scissor Lift Daily Rental',
    category: 'TOOLS_RENTAL_EXTERNAL',
    unit: 'EA',
    unitPrice: 185.0,
    vendorId: 'vnd_rental',
  },
  {
    id: 'mat_t_trowel',
    sku: 'TLS-TRWL',
    name: 'Power Trowel 36 in Daily Rental',
    category: 'TOOLS_RENTAL_EXTERNAL',
    unit: 'EA',
    unitPrice: 130.0,
    vendorId: 'vnd_rental',
  },
  {
    id: 'mat_t_breaker',
    sku: 'TLS-BRK-65',
    name: '65 lb Pneumatic Breaker Daily Rental',
    category: 'TOOLS_RENTAL_EXTERNAL',
    unit: 'EA',
    unitPrice: 88.0,
    vendorId: 'vnd_rental',
  },
  {
    id: 'mat_t_skidsteer',
    sku: 'TLS-SKID',
    name: 'Skid-Steer Loader Daily Rental',
    category: 'TOOLS_RENTAL_EXTERNAL',
    unit: 'EA',
    unitPrice: 320.0,
    vendorId: 'vnd_rental',
...
const purchaseOrders = [
  // --- Hudson Yards
  {
    ...
    poNumber: 'PO-1001',
    status: 'RECEIVED',
    expectedDelivery: D('2026-03-04'),
    createdAt: D('2026-02-21'),
    vendorId: 'vnd_concrete',
    projectId: 'prj_hudson',
    createdById: 'usr_proc_1',
    lines: [
      { id: 'pol_1001_1', materialId: 'mat_c_5000', quantity: 220, unitPrice: 185.0 },
      { id: 'pol_1001_2', materialId: 'mat_c_cure', quantity: 40, unitPrice: 78.0 },
    ],
  },
  {
    id: 'po_1002',
    ...
    expectedDelivery: D('2026-05-18'),
    createdAt: D('2026-04-30'),
    vendorId: 'vnd_rebar',
    projectId: 'prj_hudson',
    createdById: 'usr_proc_1',
    lines: [
      { id: 'pol_1002_1', materialId: 'mat_r_5', quantity: 4200, unitPrice: 2.4 },
      { id: 'pol_1002_2', materialId: 'mat_r_6', quantity: 1800, unitPrice: 3.1 },
  ...
  },
  {
    ...
    createdById: 'usr_proc_1',
    lines: [
      { id: 'pol_1003_1', materialId: 'mat_t_pump', quantity: 3, unitPrice: 75.0 },
      { id: 'pol_1003_2', materialId: 'mat_t_genset', quantity: 1, unitPrice: 245.0 },
    ],
  },
  {
    id: 'po_1004',
    ...
    createdById: 'usr_proc_1',
    lines: [
      { id: 'pol_1004_1', materialId: 'mat_f_bolt_a', quantity: 800, unitPrice: 2.1 },
  ...
  // --- LAX
  {
    ...
    poNumber: 'PO-1005',
    status: 'RECEIVED',
    expectedDelivery: D('2026-01-22'),
    createdAt: D('2026-01-09'),
    vendorId: 'vnd_concrete',
    projectId: 'prj_lax',
    createdById: 'usr_proc_2',
    lines: [
      { id: 'pol_1005_1', materialId: 'mat_c_4000', quantity: 380, unitPrice: 165.0 },
      { id: 'pol_1005_2', materialId: 'mat_c_seal', quantity: 16, unitPrice: 142.0 },
    ],
  },
  {
    id: 'po_1006',
    poNumber: 'PO-1006',
    status: 'RECEIVED',
    expectedDelivery: D('2026-02-26'),
    createdAt: D('2026-02-12'),
    vendorId: 'vnd_lumber',
    projectId: 'prj_lax',
    createdById: 'usr_proc_2',
    lines: [
      { id: 'pol_1006_1', materialId: 'mat_l_form_ply', quantity: 120, unitPrice: 102.0 },
      { id: 'pol_1006_2', materialId: 'mat_l_2x4', quantity: 400, unitPrice: 4.85 },
      { id: 'pol_1006_3', materialId: 'mat_l_screws', quantity: 30, unitPrice: 32.5 },
    ],
  },
  {
    id: 'po_1007',
    ...
    lines: [
      ...
      { id: 'pol_1007_2', materialId: 'mat_r_mesh', quantity: 80, unitPrice: 38.5 },
    ],
  },
  {
    id: 'po_1008',
    ...
    createdById: 'usr_proc_2',
    lines: [
      { id: 'pol_1008_1', materialId: 'mat_t_compactor', quantity: 6, unitPrice: 95.0 },
      { id: 'pol_1008_2', materialId: 'mat_t_trowel', quantity: 2, unitPrice: 130.0 },
    ],
  },
  ...
  // --- Mission Bay
  {
    ...
    poNumber: 'PO-1009',
    status: 'RECEIVED',
    expectedDelivery: D('2026-03-19'),
    createdAt: D('2026-03-05'),
    vendorId: 'vnd_concrete',
    projectId: 'prj_mission',
    createdById: 'usr_proc_3',
    lines: [{ id: 'pol_1009_1', materialId: 'mat_c_6000', quantity: 140, unitPrice: 215.0 }],
  },
  {
    id: 'po_1010',
    poNumber: 'PO-1010',
    status: 'SUBMITTED',
    expectedDelivery: D('2026-06-04'),
    ...
    lines: [
      ...
      { id: 'pol_1010_2', materialId: 'mat_r_dowel', quantity: 600, unitPrice: 3.2 },
    ],
  },
  {
    id: 'po_1011',
    ...
    lines: [
      ...
      { id: 'pol_1011_3', materialId: 'mat_f_epoxy', quantity: 24, unitPrice: 38.0 },
    ],
  },
  {
    id: 'po_1012',
    ...
    status: 'DRAFT',
    expectedDelivery: null,
    createdAt: D('2026-05-19'),
    vendorId: 'vnd_lumber',
    projectId: 'prj_mission',
    createdById: 'usr_proc_3',
    lines: [
      { id: 'pol_1012_1', materialId: 'mat_l_lvl', quantity: 18, unitPrice: 184.0 },
      { id: 'pol_1012_2', materialId: 'mat_l_4x4', quantity: 60, unitPrice: 17.6 },
    ],
  },
  ...
  // --- Seaport (on hold — keep some history)
  {
    ...
    poNumber: 'PO-1013',
    status: 'CLOSED',
    expectedDelivery: D('2025-12-04'),
    createdAt: D('2025-11-15'),
    vendorId: 'vnd_lumber',
    projectId: 'prj_seaport',
    createdById: 'usr_proc_1',
    lines: [
      { id: 'pol_1013_1', materialId: 'mat_l_ply_3/4', quantity: 80, unitPrice: 58.0 },
      { id: 'pol_1013_2', materialId: 'mat_l_nails', quantity: 12, unitPrice: 78.0 },
    ],
  },
  {
    id: 'po_1014',
    poNumber: 'PO-1014',
    status: 'CLOSED',
    expectedDelivery: D('2025-12-18'),
    createdAt: D('2025-12-01'),
    vendorId: 'vnd_concrete',
    projectId: 'prj_seaport',
    createdById: 'usr_proc_1',
    lines: [
      { id: 'pol_1014_1', materialId: 'mat_c_grout', quantity: 60, unitPrice: 28.5 },
      { id: 'pol_1014_2', materialId: 'mat_c_form', quantity: 8, unitPrice: 64.0 },
    ],
  },
  {
    id: 'po_1015',
    ...
    createdById: 'usr_proc_1',
    lines: [
      { id: 'pol_1015_1', materialId: 'mat_t_skidsteer', quantity: 2, unitPrice: 320.0 },
      { id: 'pol_1015_2', materialId: 'mat_t_breaker', quantity: 1, unitPrice: 88.0 },
    ],
  },
];
...
const deliveries = [
  // PO-1001 RECEIVED full (Hudson) — Eli received
  {
    ...
    deliveredAt: D('2026-03-03T09:15:00Z'),
    status: 'COMPLETE',
    receivedById: 'usr_super_1',
    notes: 'On schedule, no damage.',
    lines: [
  ...
  {
    id: 'del_1002a',
    purchaseOrderId: 'po_1002',
    deliveredAt: D('2026-05-10T13:00:00Z'),
    status: 'PARTIAL',
    receivedById: 'usr_super_2',
    notes: 'First load, #5 only.',
    lines: [{ id: 'dl_1002a_1', purchaseOrderLineId: 'pol_1002_1', quantityReceived: 2400 }],
  },
  {
    id: 'del_1002b',
    purchaseOrderId: 'po_1002',
    deliveredAt: D('2026-05-17T10:30:00Z'),
    status: 'PARTIAL',
    receivedById: 'usr_super_1',
    notes: 'Remaining #5 + first half of #6.',
    lines: [
  ...
  {
    id: 'del_1005a',
    purchaseOrderId: 'po_1005',
    deliveredAt: D('2026-01-21T08:45:00Z'),
    status: 'COMPLETE',
    receivedById: 'usr_super_3',
    notes: null,
    lines: [
  ...
  {
    id: 'del_1006a',
    purchaseOrderId: 'po_1006',
    deliveredAt: D('2026-02-25T11:00:00Z'),
    status: 'COMPLETE',
    receivedById: 'usr_super_3',
    notes: 'Stack #4 staged near gate 6.',
    lines: [
  ...
  {
    id: 'del_1007a',
    purchaseOrderId: 'po_1007',
    deliveredAt: D('2026-05-07T07:30:00Z'),
    status: 'PARTIAL',
    receivedById: 'usr_super_3',
    notes: '#4 short — backorder noted.',
    lines: [
  ...
  {
    id: 'del_1008a',
    purchaseOrderId: 'po_1008',
    deliveredAt: D('2026-03-08T09:00:00Z'),
    status: 'COMPLETE',
    receivedById: 'usr_super_3',
    notes: 'Equipment on-site.',
    lines: [
  ...
  {
    id: 'del_1009a',
    purchaseOrderId: 'po_1009',
    deliveredAt: D('2026-03-18T08:00:00Z'),
    status: 'COMPLETE',
    receivedById: 'usr_super_4',
    notes: 'Cold-pour mix, used same day.',
    lines: [{ id: 'dl_1009a_1', purchaseOrderLineId: 'pol_1009_1', quantityReceived: 140 }],
  },
  // PO-1011 PARTIAL (Mission Bay)
  {
    id: 'del_1011a',
    purchaseOrderId: 'po_1011',
    deliveredAt: D('2026-05-18T15:00:00Z'),
    status: 'PARTIAL',
    receivedById: 'usr_super_4',
    notes: 'Wedge anchors partial, epoxy full.',
    lines: [
  ...
  {
    id: 'del_1013a',
    purchaseOrderId: 'po_1013',
    deliveredAt: D('2025-12-03T10:00:00Z'),
    status: 'COMPLETE',
    receivedById: 'usr_super_1',
    notes: null,
    lines: [
  ...
  {
    id: 'del_1014a',
    purchaseOrderId: 'po_1014',
    deliveredAt: D('2025-12-17T09:00:00Z'),
    status: 'COMPLETE',
    receivedById: 'usr_super_1',
    notes: null,
    lines: [
  ...
  {
    id: 'del_1015a',
    purchaseOrderId: 'po_1015',
    deliveredAt: D('2026-02-07T08:30:00Z'),
    status: 'COMPLETE',
    receivedById: 'usr_super_2',
    notes: 'Skid steers tagged HY-SS-1, HY-SS-2.',
    lines: [
  ...
  {
    id: 'del_1003a',
    purchaseOrderId: 'po_1003',
    deliveredAt: D('2026-06-12T08:00:00Z'),
    status: 'PENDING',
    receivedById: 'usr_super_1',
    notes: 'Scheduled drop-off.',
    lines: [],
  },
  {
    id: 'del_1010a',
    purchaseOrderId: 'po_1010',
    deliveredAt: D('2026-06-04T08:00:00Z'),
    status: 'PENDING',
    receivedById: 'usr_super_4',
    notes: 'Expected morning.',
    lines: [],
  },
];
...
const equipment = [
  // --- Owned fleet (Baker) ---
  {
    ...
    createdAt: D('2026-03-21'),
  },
  {
    id: 'eqp_own_lift12',
    assetTag: 'BKR-LIFT-12',
    ...
    usefulLifeHours: 7000,
    createdAt: D('2026-02-21'),
  },
  {
    id: 'eqp_own_comp08',
    assetTag: 'BKR-COMP-08',
    ...
    createdAt: D('2026-02-16'),
  },
  {
    id: 'eqp_own_gen25',
    assetTag: 'BKR-GEN-25',
    name: '25 kW Towable Generator',
    category: 'GENERATOR',
    ownership: 'OWNED',
    status: 'IN_USE',
    dailyRate: 220,
    ...
    purchaseOrderId: null,
    hoursUsed: 9800,
    acquisitionCondition: 'REFURBISHED',
  ...
  {
    id: 'eqp_own_trwl03',
    assetTag: 'BKR-TRWL-03',
    name: '36 in Power Trowel',
    category: 'TROWEL',
    ownership: 'OWNED',
    status: 'IDLE',
    dailyRate: 120,
  ...
  },
  {
    ...
    usefulLifeHours: 3500,
    createdAt: D('2026-03-10'),
  },
  {
    id: 'eqp_own_pump09',
    assetTag: 'BKR-PUMP-09',
    name: '3 in Submersible Pump',
    category: 'PUMP',
    ownership: 'OWNED',
    status: 'IN_USE',
    dailyRate: 70,
  ...
  },
  {
    ...
    acquisitionCost: null,
    usefulLifeHours: null,
    createdAt: D('2026-01-21'),
  },
  {
    id: 'eqp_rent_brk1',
    assetTag: 'HY-BRK-1',
    name: '65 lb Pneumatic Breaker (rental)',
    category: 'BREAKER',
    ownership: 'RENTED',
    status: 'IN_USE',
    dailyRate: 88,
  ...
  // po_1003 (Hudson) — recent rental, still within term (not overdue).
  {
    id: 'eqp_rent_pump1',
    assetTag: 'HY-PUMP-1',
    name: '3 in Submersible Pump (rental)',
    category: 'PUMP',
    ownership: 'RENTED',
    status: 'IN_USE',
    dailyRate: 75,
  ...
  },
  {
    id: 'eqp_rent_gen1',
    assetTag: 'HY-GEN-1',
    name: '25 kW Towable Generator (rental)',
    category: 'GENERATOR',
    ownership: 'RENTED',
    status: 'IN_USE',
    dailyRate: 245,
...
const equipmentAssignments = [
  ...
  {
    id: 'asg_ss204_lax',
    equipmentId: 'eqp_own_ss204',
    projectId: 'prj_lax',
    startDate: D('2026-05-01'),
    expectedEndDate: D('2026-06-20'),
    actualEndDate: null,
    status: 'ACTIVE',
    dailyRate: 280,
    notes: 'Site grading, terminal apron.',
    createdById: 'usr_fleet_1',
  },
  {
    id: 'asg_ss204_hud',
    equipmentId: 'eqp_own_ss204',
    ...
    expectedEndDate: D('2026-07-10'),
    actualEndDate: null,
    status: 'SCHEDULED',
    dailyRate: 280,
    notes: 'Double-booked — needs resolution.',
    createdById: 'usr_fleet_1',
  },
  {
    id: 'asg_lift12',
    equipmentId: 'eqp_own_lift12',
    projectId: 'prj_lax',
    startDate: D('2026-04-01'),
    expectedEndDate: D('2026-07-15'),
    actualEndDate: null,
    status: 'ACTIVE',
    dailyRate: 160,
    notes: null,
  ...
  {
    id: 'asg_gen25',
    equipmentId: 'eqp_own_gen25',
    projectId: 'prj_hudson',
    startDate: D('2026-03-01'),
    expectedEndDate: D('2026-08-01'),
    actualEndDate: null,
    status: 'ACTIVE',
    dailyRate: 220,
    notes: 'Temp power, tower crane base.',
    createdById: 'usr_fleet_1',
  },
  {
    id: 'asg_trwl03',
    equipmentId: 'eqp_own_trwl03',
    projectId: 'prj_mission',
    startDate: D('2026-05-01'),
    expectedEndDate: D('2026-06-05'),
    actualEndDate: D('2026-06-04'),
    status: 'RETURNED',
    dailyRate: 120,
    notes: 'Returned damaged — see check-in.',
    createdById: 'usr_fleet_1',
  },
  {
    id: 'asg_pump09',
    equipmentId: 'eqp_own_pump09',
    projectId: 'prj_mission',
    startDate: D('2026-05-10'),
    expectedEndDate: D('2026-07-01'),
    actualEndDate: null,
    status: 'ACTIVE',
    dailyRate: 70,
    notes: null,
  ...
  {
    id: 'asg_exc14',
    equipmentId: 'eqp_own_exc14',
    projectId: 'prj_lax',
    startDate: D('2026-04-15'),
    expectedEndDate: D('2026-09-01'),
    actualEndDate: null,
    status: 'ACTIVE',
    dailyRate: 480,
    notes: 'Down for hydraulic repair.',
    createdById: 'usr_fleet_1',
  },
  ...
  {
    id: 'asg_comp08',
    equipmentId: 'eqp_own_comp08',
    projectId: 'prj_mission',
    startDate: D('2026-03-01'),
    expectedEndDate: D('2026-04-12'),
    actualEndDate: D('2026-04-10'),
    status: 'RETURNED',
    dailyRate: 85,
    notes: 'Backfill compaction, returned to yard.',
    createdById: 'usr_fleet_1',
  },
  {
    id: 'asg_saw22',
    equipmentId: 'eqp_own_saw22',
    projectId: 'prj_lax',
    startDate: D('2026-04-05'),
    expectedEndDate: D('2026-05-22'),
    actualEndDate: D('2026-05-20'),
    status: 'RETURNED',
    dailyRate: 130,
    notes: 'Slab sawing, back in yard.',
    createdById: 'usr_fleet_1',
  },
  // Rented-in machines on po_1015 (Hudson) — still on rent past term
  {
    id: 'asg_ss1',
    equipmentId: 'eqp_rent_ss1',
    projectId: 'prj_hudson',
    startDate: D('2026-02-07'),
    expectedEndDate: D('2026-05-31'),
    actualEndDate: null,
    status: 'ACTIVE',
    dailyRate: 320,
    notes: 'On rent past term.',
    createdById: 'usr_fleet_1',
  },
  {
    id: 'asg_ss2',
    equipmentId: 'eqp_rent_ss2',
    projectId: 'prj_hudson',
    startDate: D('2026-02-07'),
    expectedEndDate: D('2026-05-31'),
    actualEndDate: null,
    status: 'ACTIVE',
    dailyRate: 320,
    notes: 'Idle on site, still on rent — return it.',
    createdById: 'usr_fleet_1',
  },
  {
    id: 'asg_brk1',
    equipmentId: 'eqp_rent_brk1',
    projectId: 'prj_hudson',
    startDate: D('2026-02-07'),
    expectedEndDate: D('2026-05-31'),
    actualEndDate: null,
  ...
  {
    id: 'asg_comp1',
    equipmentId: 'eqp_rent_comp1',
    projectId: 'prj_lax',
    startDate: D('2026-03-08'),
    expectedEndDate: D('2026-04-30'),
    actualEndDate: D('2026-04-28'),
    status: 'RETURNED',
    dailyRate: 95,
    notes: 'Off-rented two days early.',
    createdById: 'usr_fleet_1',
  },
];
...
const equipmentEvents = [
  {
    id: 'evt_ss1_out',
    equipmentId: 'eqp_rent_ss1',
    assignmentId: 'asg_ss1',
    type: 'CHECK_OUT',
    condition: 'GOOD',
    photoUrl: null,
    notes: 'Received from Western, fuel full.',
    projectId: 'prj_hudson',
    userId: 'usr_super_2',
    occurredAt: D('2026-02-07T08:30:00Z'),
    syncedAt: D('2026-02-07T08:30:00Z'),
  },
  {
    id: 'evt_ss2_out',
    equipmentId: 'eqp_rent_ss2',
    assignmentId: 'asg_ss2',
    type: 'CHECK_OUT',
    condition: 'GOOD',
    photoUrl: null,
    notes: null,
    projectId: 'prj_hudson',
    userId: 'usr_super_2',
    occurredAt: D('2026-02-07T08:35:00Z'),
    syncedAt: D('2026-02-07T08:35:00Z'),
  },
  {
    id: 'evt_trwl_out',
    equipmentId: 'eqp_own_trwl03',
    assignmentId: 'asg_trwl03',
    type: 'CHECK_OUT',
    condition: 'GOOD',
    photoUrl: null,
    notes: 'Blades good.',
    projectId: 'prj_mission',
    userId: 'usr_super_4',
    occurredAt: D('2026-05-01T07:00:00Z'),
    syncedAt: D('2026-05-01T07:00:00Z'),
  },
  ...
  // with no signal, synced at 19:45 once back online (offline gap).
  {
    ...
    type: 'CHECK_IN',
    condition: 'DAMAGED',
    photoUrl: 'photos/BKR-TRWL-03-20260604-blade.jpg',
    notes: 'Returned with bent blade and oil leak. Photographed at handoff.',
    projectId: 'prj_mission',
    userId: 'usr_super_4',
    occurredAt: D('2026-06-04T16:30:00Z'),
    syncedAt: D('2026-06-04T19:45:00Z'),
  },
  {
    id: 'evt_comp_out',
    equipmentId: 'eqp_rent_comp1',
    assignmentId: 'asg_comp1',
    type: 'CHECK_OUT',
    condition: 'GOOD',
    photoUrl: null,
    notes: null,
    projectId: 'prj_lax',
    userId: 'usr_super_3',
    occurredAt: D('2026-03-08T09:00:00Z'),
    syncedAt: D('2026-03-08T09:00:00Z'),
  },
  {
    id: 'evt_comp_off',
    equipmentId: 'eqp_rent_comp1',
    ...
    condition: 'GOOD',
    photoUrl: null,
    notes: 'Picked up by Western, two days early.',
    projectId: 'prj_lax',
    userId: 'usr_super_3',
    occurredAt: D('2026-04-28T14:00:00Z'),
    syncedAt: D('2026-04-28T14:00:00Z'),
  },
  ...
  // ARE the breakdown record (no separate MaintenanceRecord; maintenance is deferred to Phase 2).
  {
    id: 'evt_exc_down',
    equipmentId: 'eqp_own_exc14',
    assignmentId: 'asg_exc14',
    type: 'DOWN',
    condition: 'NEEDS_SERVICE',
    photoUrl: 'photos/BKR-EXC-14-20260610-hydraulic.jpg',
    notes:
      'Hydraulic leak — boom will not lift. Tagged out of service. Awaiting CAT field service.',
    projectId: 'prj_lax',
    userId: 'usr_super_3',
    occurredAt: D('2026-06-10T11:00:00Z'),
    syncedAt: D('2026-06-10T14:20:00Z'),
  },
];
...
async function main() {
  ...
  console.log(`  users=${users.length} vendors=${vendors.length} materials=${materials.length}`);
  console.log(
